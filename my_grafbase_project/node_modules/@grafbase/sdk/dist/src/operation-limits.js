...
var OPERATION_LIMITS_PARAMS_KEYS = ['aliases', 'complexity', 'depth', 'height', 'rootFields'];
var OperationLimits = /** @class */ (function () {
    ...
    OperationLimits.prototype.toString = function () {
        var _this = this;
        var parameters = OPERATION_LIMITS_PARAMS_KEYS
            .map(function (key) { return _this.params[key] ? "".concat(key, ": ").concat(_this.params[key]) : null; })
