 ...
 */
export type Providable = ScalarDefinition | DefaultDefinition | ReferenceDefinition | EnumDefinition<any, any> | TagDefinition;
export declare class ProvidesDefinition {
    private field;
    private fields;
