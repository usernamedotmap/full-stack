 ...
 */
export type Shareable = ScalarDefinition | DefaultDefinition | ReferenceDefinition | EnumDefinition<any, any> | TagDefinition;
export declare class ShareableDefinition {
    private field;
